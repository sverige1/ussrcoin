...
static const int64 MAX_MONEY = 19000000000 * COIN; // UssrCoin: maximum of 19B coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2880 / 250; // UssrCoin: 2880 blocks found a day. Priority cutoff is 1 UssrCoin day / 250 bytes.
    }
