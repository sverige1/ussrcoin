        ...
        cachedNumBlocks(0)
{
    ...
    connect(timer, SIGNAL(timeout()), this, SUSR(updateConfirmations()));
    timer->start(MODEL_UPDATE_DELAY);

    connect(walletModel->getOptionsModel(), SIGNAL(displayUnitChanged(int)), this, SUSR(updateDisplayUnit()));
}
